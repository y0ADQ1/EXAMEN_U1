...
exports.Options = exports.TransactionOptions = exports.RetryOptions = exports.RetryCondition = exports.IsolationLevel = void 0;
...
function logWarnings(warnings) {
    for (const warning of warnings) {
        console.warn(new Error(`Gel warning: ${warning.message}`, { cause: warning }));
    }
}
class RetryOptions {
    default;
...
class Options {
    ...
    constructor({ retryOptions = RetryOptions.defaults(), transactionOptions = TransactionOptions.defaults(), warningHandler = logWarnings, module = "default", moduleAliases = {}, config = {}, globals = {}, codecs = {}, } = {}) {
