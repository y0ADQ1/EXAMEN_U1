...
declare class BaseFetchConnection extends BaseRawConnection {
    ...
    fetch(...args: Parameters<BaseRawConnection["fetch"]>): Promise<{
        result: any;
        warnings: import("./errors").GelError[];
    }>;
...
export declare class AdminUIFetchConnection extends BaseFetchConnection {
    ...
    rawParse(language: Language, query: string, state: Options, options?: QueryOptions, abortSignal?: AbortSignal | null): Promise<[
        ICodec,
        ICodec,
        Uint8Array,
        Uint8Array,
    ...
    rawExecute(language: Language, query: string, state: Options, outCodec?: ICodec, options?: QueryOptions, inCodec?: ICodec, args?: QueryArgs, abortSignal?: AbortSignal | null): Promise<Uint8Array>;
}
