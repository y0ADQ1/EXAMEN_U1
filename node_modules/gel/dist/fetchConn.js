...
class AdminUIFetchConnection extends BaseFetchConnection {
    ...
    async rawExecute(language, query, state, outCodec, options, inCodec, args = null, abortSignal) {
        ...
        await this._executeFlow(language, query, args, outCodec ? ifaces_1.OutputFormat.BINARY : ifaces_1.OutputFormat.NONE, ifaces_1.Cardinality.MANY, state, inCodec ?? codecs_1.NULL_CODEC, outCodec ?? codecs_1.NULL_CODEC, result, STUDIO_CAPABILITIES, options);
